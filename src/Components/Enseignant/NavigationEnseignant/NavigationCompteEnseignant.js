...
function NavigationCompteEnseignant() {
        ...
        <Menu as="div" className="relative inline-block text-left" >
            <div>
                <Menu.Button className="inline-flex w-full gap-x-1.5 rounded-full px-3 py-3 ">
                    {avatar ? (
                        <div className='w-12 h-12 rounded-full flex items-center justify-center bg-blue-800 text-white font-bold' style={{ 'fontSize': 24 }}>
                            {avatar}
                        </div>
                    ) : (
                        <img src={profile} alt="Profile" style={{ width: '100%', height: 44 }} className='rounded-full' />
                    )}
                </Menu.Button>
            </div>
...
export default NavigationCompteEnseignant
